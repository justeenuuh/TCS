	...
	if(isset($_POST['returned']))
					{
						...
						$code = $_POST['code'];
						$time = date("h:i:s a");
						$query = "UPDATE borrower SET Status = 'Returned', TimeR = '$time' WHERE BorrowerID = '$id'";
						$responses = @mysqli_query($dbc, $query);
						
						$query1 = "UPDATE thesis SET status = 'Available' WHERE code = '$code'";
